...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('home_page_contents', function (Blueprint $table) {
            ...
            $table->string('section_type'); // e.g., 'hero', 'info_block', 'content', 'video', 'values', 'advisors', 'board'
            ...
            $table->json('data')->nullable(); // For structured data like values list, advisors array, etc.

...
class EventsController extends BaseController
{
    ...
    {
        $section = HomePageSection::where('section_key', 'events')
            ->where('section_type', 'events')
            ->first();
        ...
        if (!$section) {
            $section = HomePageSection::create([
                ...
                'description' => 'Control events section display settings',
        ...
        return view('admin.homepage.events.index', [
            'section' => $section,
            'settings' => $settings,
        ]);
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route('admin.homepage.events.index')
            ->with('success', 'Events display settings updated successfully.');
    }

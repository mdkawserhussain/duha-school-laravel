...
@section('content')
    ...
    <section class="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row items-center gap-8">
                ...
                @else
                    <div class="flex-shrink-0 w-48 h-48 rounded-full bg-white bg-opacity-20 flex items-center justify-center border-4 border-white">
                ...
                <div class="text-center md:text-left">
                    <h1 class="text-4xl font-bold mb-2">{{ $staff->name }}</h1>
                    <p class="text-xl text-blue-100 mb-4">{{ $staff->position }}</p>
                    @if($staff->email || $staff->phone)
                        <div class="flex flex-col md:flex-row gap-4 justify-center md:justify-start">
                            @if($staff->email)
                                <a href="mailto:{{ $staff->email }}" class="flex items-center gap-2 text-white hover:text-blue-200 transition">
                            ...
                            @endif
                            @if($staff->phone)
                                <a href="tel:{{ $staff->phone }}" class="flex items-center gap-2 text-white hover:text-blue-200 transition">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <section class="py-8 bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <a href="{{ route('staff.index') }}" class="inline-flex items-center text-blue-600 hover:text-blue-800 transition">

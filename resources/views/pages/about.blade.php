            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div x-data="{ show: false }" x-init="setTimeout(() => show = true, 300)" 
                    ...
                    <p class="text-gray-600 text-lg leading-relaxed opacity-0 transform translate-y-8 transition-all duration-1000 delay-300 ease-out"
                       :class="{ 'opacity-100 translate-y-0': show }">
                        {{ $page->hero_subtitle ?? $page->excerpt ?? ($siteName . ', established in 2020 under the leadership of its Founder and Director, Hasan Mahmud, is committed to delivering high-quality education that combines a modern English-medium curriculum with strong moral and Islamic values. Our mission is to nurture confident, disciplined, and capable students who are prepared for a bright and successful future.') }}
                    </p>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="space-y-6 text-gray-700 leading-relaxed text-justify">
                @if($page->content)
                    {!! $page->content !!}
                @else
                    <p>Duha International School, established in 2020 under the leadership of its Founder and Director, Hasan Mahmud, is a modern English-medium institution in Chattogram dedicated to providing high-quality academic education combined with strong moral and cultural values. The school was established with the vision of creating a safe, student-centered learning environment where children receive balanced development in academics, character, creativity, and life skills. </p>

<p>From the very beginning, Duha International School started its journey with a commitment to accessible quality education for families seeking an institution that emphasizes discipline, values, and academic excellence. The school began operations at its campus in the Port Connecting Road area of Halishahar, Chattogram, and has been steadily growing in both reputation and student enrollment. </p>

<p>

Our goal is to help learners build a strong foundation in English, Mathematics, Science, ICT, and Languages while nurturing confidence, responsibility, compassion, and leadership qualities. The curriculum is designed to suit 21st-century learning needs through activity-based lessons, interactive classrooms, and a supportive learning environment guided by experienced teachers. </p>

<p>

Duha International School continues to work toward becoming a leading educational institution in Chattogram by focusing on continuous improvement, professional teaching practices, and meaningful engagement with parents and the community.</p>
<p>The academy aims to provide a balanced education that integrates general education with Islamic values. It strives to create an environment where students can develop their intellectual, physical, and spiritual potential to the fullest.</p>
<p>Our curriculum is designed to meet the challenges of the 21st century while keeping our students rooted in their cultural and religious heritage. We believe in nurturing future leaders who are not only academically competent but also morally upright.</p>
                @endif
            </div>
        </div>
    </section>

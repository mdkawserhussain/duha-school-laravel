    ...
    <div class="relative z-10 w-full mx-auto px-4 sm:px-6 lg:px-8 pb-12 sm:pb-16 md:pb-20"
        ...
        <div class="max-w-4xl mx-auto text-center">
            ...
            <h1 x-data="{ show: false }" x-init="setTimeout(() => show = true, 300)" 
                class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight tracking-tight text-[#01041c] mb-4 sm:mb-6 opacity-0 transform translate-y-8 transition-all duration-1000 ease-out"
                :class="{ 'opacity-100 translate-y-0': show }"

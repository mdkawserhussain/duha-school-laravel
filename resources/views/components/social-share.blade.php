...
<div class="flex items-center gap-3 {{ $attributes->get('class') }}">
    ...
    <a 
        ...
        target="_blank" 
        rel="noopener noreferrer"
        class="bg-black hover:bg-gray-800 text-white p-2 rounded-lg transition duration-300"
    ...
    <a 
        ...
        target="_blank" 
        rel="noopener noreferrer"
        class="bg-blue-700 hover:bg-blue-800 text-white p-2 rounded-lg transition duration-300"
    ...
    <button 
        ...
        class="bg-gray-600 hover:bg-gray-700 text-white p-2 rounded-lg transition duration-300"

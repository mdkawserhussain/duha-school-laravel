...
@php
    ...
    $services = [
        [
            ...
            'bgColor' => 'bg-za-green-primary', // Green background (FR-7.3)
        ...
        [
            ...
            'bgColor' => 'bg-purple-500', // Purple background (FR-7.3)
            'textColor' => 'text-white',
            'link' => '#',
        ],
        [
            ...
            'bgColor' => 'bg-orange-500', // Orange background (FR-7.3)
            'textColor' => 'text-white',
            'link' => '#',
        ],
        [
            ...
            'bgColor' => 'bg-blue-500', // Blue background (FR-7.3)
            'textColor' => 'text-white',
            'link' => '#',
        ],
        [
            ...
            'bgColor' => 'bg-pink-500', // Pink background (FR-7.3)
            'textColor' => 'text-white',
            'link' => '#',
        ],
    ];
...
<section class="py-16 lg:py-24 bg-white relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a href="{{ $service['link'] }}" 
               class="group {{ $service['bgColor'] }} {{ $service['textColor'] }} rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 transform"

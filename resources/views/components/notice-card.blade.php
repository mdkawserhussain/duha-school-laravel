...
<div class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition duration-300">
    @if($notice->featured_image)
        <img src="{{ $notice->featured_image }}" alt="{{ $notice->title }}" class="w-full h-48 object-cover">
    @else
        <div class="w-full h-48 bg-gradient-to-r from-green-500 to-green-600 flex items-center justify-center">
    ...
    <div class="p-6">
        ...
        <a href="{{ route('notices.show', $notice) }}" class="inline-flex items-center text-blue-600 hover:text-blue-800 font-medium transition duration-300">
            Read More

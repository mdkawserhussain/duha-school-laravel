...
@section('title', 'News Display Settings')
@section('page-title', 'News Display Settings')
...
<div class="max-w-4xl">
    ...
    <form action="{{ route('admin.homepage.news.update') }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <div class="space-y-6">
                ...
                <!-- Items Count -->
                <div>
                    <label for="items_count" class="block text-sm font-medium text-gray-700">Number of News Items to Display <span class="text-red-500">*</span></label>
                    ...
                    <p class="mt-1 text-sm text-gray-500">Maximum number of news items to show (1-20)</p>
                    @error('items_count')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500">How news items should be displayed on the homepage</p>
                    @error('layout_style')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" name="button_link" id="button_link" value="{{ old('button_link', $section->button_link) }}" maxlength="255" placeholder="/notices" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-za-green-primary focus:ring-za-green-primary">
                    <p class="mt-1 text-sm text-gray-500">URL path (e.g., /notices)</p>
                    @error('button_link')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-lg p-6">
            ...
            <p class="text-sm text-blue-700 mb-4">Manage the notices/news that appear in this section:</p>

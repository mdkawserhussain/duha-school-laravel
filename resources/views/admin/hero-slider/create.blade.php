...
@section('content')
<div class="max-w-4xl">
    <form action="{{ route('admin.hero-slider.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf
        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="badge" id="badge" value="{{ old('badge') }}" placeholder="e.g., New, Featured" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-za-green-primary focus:ring-za-green-primary">
                    @error('badge')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="url" name="video_url" id="video_url" value="{{ old('video_url') }}" placeholder="https://example.com/video.mp4" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-za-green-primary focus:ring-za-green-primary">
                    @error('video_url')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
